...
void initGrammer() {
	...
	temp[0].left_symbol = "start";
	temp[0].right_symbol.push_back("S");
	grammer.productItems.push_back(temp[0]);

	temp[1].left_symbol = "S";
	temp[1].right_symbol.push_back("B");
	temp[1].right_symbol.push_back("B");
	grammer.productItems.push_back(temp[1]);

	temp[2].left_symbol = "B";
	temp[2].right_symbol.push_back("a");
	temp[2].right_symbol.push_back("B");
	grammer.productItems.push_back(temp[2]);

	temp[3].left_symbol = "B";
	temp[3].right_symbol.push_back("b");
	grammer.productItems.push_back(temp[3]);

	//temp[4].left_symbol = "B";
	//temp[4].right_symbol.push_back("@");
	//grammer.productItems.push_back(temp[4]);

	grammer.startItemPos = 0;

	grammer.Terminals.insert("a");
	grammer.Terminals.insert("b");
	//grammer.Terminals.insert("@");

	grammer.NTterminals.insert("start");
	grammer.NTterminals.insert("S");
	grammer.NTterminals.insert("B");
}*/
